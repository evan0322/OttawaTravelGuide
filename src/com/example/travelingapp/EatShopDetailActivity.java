...
public class EatShopDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eatshopdetail);
		...
		service=new DBService(EatShopDetailActivity.this);
...
//Hyperlink intent
class MyOnClickListenerEatShop implements OnClickListener
{

	private Context con;
	private String url;
	public MyOnClickListenerEatShop(Context con,String url)
	{
		this.con=con;
		this.url=url;
	}
